...
const Header = (props: { children: ReactNode; className?: string }) => {
  return (
    <header
      className={twMerge(
        "bg-white flex flex-col justify-center pt-4 sm:pt-6 pb-2 sm:pb-3 z-10 safe-area-top",
...
const Main = (props: { children: ReactNode; className?: string }) => {
  return (
    <main
      className={twMerge(
        clsx(
          "grow overflow-y-auto pt-2 sm:pt-3 pb-16 sm:pb-6",
          props.className,
        ),
      )}
    >
...
const Footer = (props: { children: ReactNode; className?: string }) => {
  return (
    <footer
      className={twMerge(
        "px-4 sm:px-6 lg:px-8 pb-6 sm:pb-[35px] safe-area-bottom",
        clsx(props.className),
      )}
    >
      {props.children}
