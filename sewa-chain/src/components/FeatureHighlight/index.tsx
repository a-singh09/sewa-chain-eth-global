...
export const FeatureHighlight: React.FC<FeatureHighlightProps> = ({
  ...
  return (
    <div
      className={`
        card-mobile bg-white rounded-xl border border-gray-200 
    ...
    >
      {/* Icon Container */}
      <div className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 mb-3 sm:mb-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl">
      ...
      {/* Visual Accent */}
      <div className="mt-3 sm:mt-4 h-1 w-10 sm:w-12 bg-gradient-to-r from-blue-600 to-green-600 rounded-full"></div>
    </div>
  );
};

// Preset feature components for flood relief context
export const DuplicatePreventionFeature: React.FC<{
  animationDelay?: number;
}> = ({ animationDelay }) => (
  <FeatureHighlight
    icon={
...
export const BlockchainTransparencyFeature: React.FC<{
  animationDelay?: number;
}> = ({ animationDelay }) => (
  <FeatureHighlight
    icon={
...
export const RealTimeTrackingFeature: React.FC<{ animationDelay?: number }> = ({
  animationDelay,
}) => (
  <FeatureHighlight
    icon={
