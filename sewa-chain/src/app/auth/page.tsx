      ...
      <Page>
        <div className="max-w-md mx-auto p-6">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Volunteer Authentication</h1>
          ...
          <div className="mt-6 text-center text-xs text-gray-500">
            <p>Your identity will be verified using World ID for security and to prevent fraud.</p>
          </div>
        </div>
      </Page>
    );
      ...
      <Page>
        <div className="max-w-md mx-auto p-6">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Beneficiary Registration</h1>
            <p className="text-gray-600">
          ...
          <div className="space-y-4">
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
              <p className="text-sm text-green-800">
                <strong>Note:</strong> As a beneficiary, you can register for aid assistance.
              </p>
            </div>
      ...
      <Page>
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <h2 className="text-xl font-bold text-gray-900 mb-2">Invalid User Type</h2>
            <p className="text-gray-600 mb-4">Please select a valid user type</p>
            <Button onClick={() => router.push('/')} variant="primary">
              Return to Home
            </Button>
          </div>
