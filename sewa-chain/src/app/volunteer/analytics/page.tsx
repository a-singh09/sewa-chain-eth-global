        ...
        {!loading && !error && analyticsData && (
          <>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 mb-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-semibold text-gray-900">Recent Distributions</h2>
                <Button variant="secondary">View All</Button>
              </div>

              {analyticsData.recentDistributions.length > 0 ? (
                <ActivityTimeline 
                  distributions={analyticsData.recentDistributions} 
                />
              ) : (
            ...
            {/* Distribution Map */}
            <div className="bg-white rounded-xl shadow-md p-6 mb-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-6">Distribution Map</h2>
              
              <div className="bg-gray-100 rounded-lg p-8 text-center">
                <MapPinIcon className="w-16 h-16 text-gray-300 mx-auto mb-4" />
                <h3 className="text-lg font-medium text-gray-900 mb-2">Distribution Heatmap</h3>
                <p className="text-gray-500 mb-4">
                  Visual representation of aid distribution across regions
                </p>
                <Button variant="primary">View Detailed Map</Button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                <h2 className="text-xl font-semibold text-gray-900 mb-6">Aid Type Distribution</h2>
              ...
              {/* Distribution Trends */}
              <div className="bg-white rounded-xl shadow-md p-6">
                <h2 className="text-xl font-semibold text-gray-900 mb-6">Weekly Trends</h2>
                
                <div className="bg-gray-50 rounded-lg p-6 text-center">
                  <ChartBarIcon className="w-12 h-12 text-gray-300 mx-auto mb-4" />
                  <h3 className="text-lg font-medium text-gray-900 mb-2">Distribution Over Time</h3>
                  <p className="text-gray-500">
                    Graph showing distribution activity over the past week
                  </p>
                  <Button variant="secondary" className="mt-4">View Detailed Chart</Button>
                </div>
              </div>
            </div>
          </>
