...
export default function VolunteerVerifyPage() {
    ...
    return (
      <Page>
        <Page.Header className="p-0">
          <Navbar title="Volunteer Verified" />
        </Page.Header>
        <Page.Main>
          <div className="max-w-md mx-auto text-center">
            <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
              ...
              <p className="text-green-700 mb-4">
                You are currently authenticated as volunteer{" "}
                {session.volunteerId}
              </p>
  ...
  return (
    <Page>
      <Page.Header className="p-0">
        <Navbar title="Volunteer Verification" showBackButton={true} />
      </Page.Header>
      <Page.Main>
        <div className="max-w-lg mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Complete World ID verification to become an authorized volunteer
